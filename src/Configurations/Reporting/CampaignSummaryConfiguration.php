...
class CampaignSummaryConfiguration implements ConfigurationsInterface, PathConfigurationInterface
{
    private $config;
    private $pathConfig;
    ...
    {
        return strtr(URI::CAMPAIGN_SUMMARY_REPORT_URI, $this->pathConfig);
    }
}
